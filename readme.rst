...
Et pour quitter un screen ``CTRL + A`` puis ``CTRL + D``. Surtout ne JAMAIS faire un ``CTRL + C`` car ça arrêtera le processus de screen et donc inévitablement le serveur Minecraft.
